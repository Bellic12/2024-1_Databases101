...
GRANT INSERT ON inscripcion TO  'PersonaU'; 

-- Permisos tabla: convocatoria -- 
GRANT SELECT ON convocatoria TO  'PersonaU'; 
...
GRANT SELECT ON vw_NUM_CursosEstudiante TO 'Empleados'; 
GRANT UPDATE ON vw_NUM_CursosEstudiante to  'Empleados';
GRANT INSERT ON vw_NUM_CursosEstudiante to  'Empleados';
